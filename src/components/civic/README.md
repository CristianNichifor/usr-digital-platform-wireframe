...
The demo uses [Civic UI v0.5.0](https://github.com/CristianNichifor/civic-ui/releases/tag/v0.5.0). The root package manifest pins its GitHub release tarball and the lockfile records its integrity. No npm account or local filesystem dependency is needed.
