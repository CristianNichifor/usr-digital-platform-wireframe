...
Suita completa de 29 teste ruleaza in Chromium, Firefox si WebKit (87 executii). Controalele de formular, butoanele si cele sapte tabele folosesc Civic UI v0.5.0. Testele verifica filtre, resetare, indisponibilitate/reincercare, operare offline, etichete, focus, contrast si padding. Sunt acoperite participarea cu tastatura si revizuirea raspunsului, consimtamantul explicit si retragerea lui, accesul demonstrativ restrictionat, descarcarile sintetice si absenta persistentei sau cererilor externe in fluxurile verificate. Formularul public de contact ramane static, fara trimitere. Paginile publice cu formulare si tabele sunt verificate la 320, 390 si 1440px, inclusiv etichetele celulelor in afisarea mobila. Pentru un singur motor: `npm test -- --project=firefox`. `DEMO_CHROMIUM` afecteaza numai proiectul Chromium.
...
- [src/components/civic/README.md](src/components/civic/README.md): inventarul adoptarii Civic UI v0.5.0 si exceptiile intentionate.
